    ...
    <div className="swiper-card">
      <div className=" prortfolio-items row">
        <div>
          ...
          <ul>
            <li>
              <h4 className="h4">JavaScript, Typescript</h4>
            </li>
            <li>
              <h4 className="h4">HTML, CSS</h4>
            </li>
          </ul>
          <h3 className="h3">{getLocaleContent(locale, `common.FR&PLA`)}</h3>
          <ul>
            <li>
              <h4 className="h4">ReactJS / NextJS / NodeJS / Strapi</h4>
            </li>
            <li>
              <h4 className="h4">RestfulAPI</h4>
            </li>
            <li>
              <h4 className="h4">Redis / ExpressJS / Rabbitmq</h4>
            </li>
            <li>
        ...
        <div>
          ...
          <h3 className="h3">{getLocaleContent(locale, `common.control`)}</h3>
          <ul>
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              <h4 className="h4">
                {getLocaleContent(locale, `common.known1`)}
              </h4>
            </li>
            <li>
              <h4 className="h4">
                {getLocaleContent(locale, `common.known2`)}
              </h4>
            </li>
            <li>
              <h4 className="h4">
                {getLocaleContent(locale, `common.known3`)}
              </h4>
            </li>
            <li>
              <h4 className="h4">
                {getLocaleContent(locale, `common.known4`)}
              </h4>
            </li>
          </ul>
        </div>
